...
describe("pathUtil", function() {
    ...
    describe("normalizeFilepath()", function() {
        ...
        it("should remove a leading './'", function() {
            ...
            var result = pathUtil.normalizeFilepath(input);
        ...
        it("should remove current path '.\\' from windows style paths", function() {
            var input = ".\\windows\\style\\path.js";
            var result = pathUtil.normalizeFilepath(input);
        ...
        it("should remove interior '..\\' from windows style paths", function() {
            var input = ".\\windows\\style\\..\\path.js";
            var result = pathUtil.normalizeFilepath(input);

            assert.equal(result, "windows/path.js");
        });
