...
IgnoredPaths.prototype.contains = function(filepath, category) {
    ...
    var normalizedPath = pathUtil.normalizeFilepath(absolutePath);
    var relativePath = pathUtil.normalizeFilepath(pathUtil.getRelativePath(normalizedPath, this.options.cwd));
